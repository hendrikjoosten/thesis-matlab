...
filename = 'D:\calibration\BLGPHSBROKEN\GOPR2173.MP4';

%reading a video file
mov = VideoReader(filename);

% Defining Output folder as 'snaps'
opFolder = fullfile('D:\calibration\BLGPHSBROKEN\snaps');
%if  not existing 
if ~exist(opFolder, 'dir')
%make directory & execute as indicated in opfolder variable
mkdir('D:\calibration\BLGPHSBROKEN\snaps');
end
...
opBaseFileName = sprintf('BL%3.3d.png', t);
