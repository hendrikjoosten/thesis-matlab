...
filename = 'D:\calibration\BRGPHS\GOPR2202.MP4';

%reading a video file
mov = VideoReader(filename);

% Defining Output folder as 'snaps'
opFolder = fullfile('D:\calibration\BRGPHS\snaps');
%if  not existing 
if ~exist(opFolder, 'dir')
%make directory & execute as indicated in opfolder variable
mkdir('D:\calibration\BRGPHS\snaps');
end
...
opBaseFileName = sprintf('BR%3.3d.png', t);
