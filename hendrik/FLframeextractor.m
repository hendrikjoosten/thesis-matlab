...
filename = 'D:\calibration\FLGPHSRED\GOPR0002.MP4';

%reading a video file
mov = VideoReader(filename);

% Defining Output folder as 'snaps'
opFolder = fullfile('D:\calibration\FLGPHSRED\snaps');
%if  not existing 
if ~exist(opFolder, 'dir')
%make directory & execute as indicated in opfolder variable
mkdir('D:\calibration\FLGPHSRED\snaps');
end
...
opBaseFileName = sprintf('FL%3.3d.png', t);
